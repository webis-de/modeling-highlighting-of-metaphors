from inference_analysis_sigtest_without_metaphor import InferenceRankingEvaluator
...
model_dict_scm = {
            without_hghl:'predict-scm-single-nopretrain',
            without_hghl_multi:'predict-scm-multi',
            with_hghl:'predict-scm-single-withpretrain'
            }

model_dict_hghl = {
            best_without_scm:'predict-hghl-single-nopretrain',
            best_without_scm_multi:'predict-hghl-multi',
            best_with_scm:'predict-hghl-single-withpretrain'
            }
...
result = InferenceRankingEvaluator(
                                ...
                                model_dict_scm[without_hghl_multi],
                                task)
result()
...
"Want: to have children,  to be a good person,  to have a family","Intents:  to be born,  to be a person","Attributes:  curious,  
intelligent, born","Reactions:  happy, happy,  excited","Effects: speaker is born,  speaker is born","Needs:  to be born,  to have been born",
"Reasons: speaker is born,  speaker was born,  speaker is born into the world"
'''
