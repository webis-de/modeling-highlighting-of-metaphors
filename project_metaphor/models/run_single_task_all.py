...
''' 
    run sBERT single Task Experiment with Bert-based encoders for all parameters 
'''
...
'''
true_top3 :  Protection                                                                                                                                                                                                                                                                                                       
, pred3 :  ['Confinement/Physical Harm', 'Crime/Physical Harm', 'Physical Harm/Protection']

true_top5 :  Protection                                                        
, pred5 :  ['Confinement/Physical Harm', 'Crime/Physical Harm', 'Physical Harm/Protection', 'Physical Harm', 'Natural Physical Force/Physical Harm/Protection']                                                                                                                                                               


true_top3 :  Struggle/War                                                                                                                                                                                                                                                                                                     
, pred3 :  ['Rule Enforcer', 'Backward Movement/War', 'A Right']

true_top5 :  Struggle/War                                                      
, pred5 :  ['Rule Enforcer', 'Backward Movement/War', 'A Right', 'Physical Location/Protection/Natural Physical Force', 'Forward Movement']                                                                                                                                                                                   
