...
if add_xIntent == 1:
    ...
    wandb.init(project=model_name+"-"+task+"-"+sub_task+"-split-"+str(test_split)+"-eval_sub- "+eval_subset+"-without_csr-batch_size- "+str(train_batch_size)+"-testwOUThghlasfeat", entity="msen")
...
if task =='single':
    ...
    train_model_single_task(itr,
                ...
                model_suffix='single-hghl-split0-batch32', 
                data_file_suffix='', 
                max_seq_length=512, 
                add_special_token=False, 
                loss='MultipleNegativesRankingLoss', 
