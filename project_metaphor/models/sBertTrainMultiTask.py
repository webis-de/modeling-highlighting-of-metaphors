...
# model_name = './model_config/distilbert-base-uncased-single-hghl-split0-batch32-2023-01-30_14-41-27-bestwithoutscm/'
# model_name = './model_config/distilbert-base-uncased-single-hghl-split0-batch32-2022-12-30_14-55-43_best_scm_without_csr_32/'
...
if add_xIntent == 1:
    ...
    wandb.init(project="scm_new_multitask_with_pretoken", entity="msen")
...
def train_model_multitask(itr,
    ...
    if task=='hghl':
        if add_xIntent == 0:
            ...
            sentences_hghl = '<hghl>'+var_hghl['Sentence']+'<SEP>'+ \
        ...
        if add_xIntent == 0:
            sentences_scm = '<scm>'+var_scm['Sentence']  
            pos_scm = var_scm['Source CM']
            assert len(sentences_scm) == len(pos_scm)
        else:
            print('*** Adding knowledge to dev data ***')
            sentences_scm = '<scm>'+var_scm['Sentence']+'<SEP>'+ \
...
train_model_multitask(itr,
            ...
            model_suffix='multi-split0-batch32', 
            data_file_suffix='', 
            max_seq_length=512, 
            add_special_token=False, 
            loss='MultipleNegativesRankingLoss', 
